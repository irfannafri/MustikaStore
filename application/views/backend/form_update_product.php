				...
				<div class="col-md-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4>
								<i class="fa fa-fw fa-compass"></i>Edit Produk
							</h4>
						</div><!-- /..panel-heading -->
						...
						<?=  form_open_multipart('admin/products/edit/'.$pro_id,['class'=>'form-group']) ?>
							<div class="col-sm-4">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="pro_name" placeholder="Masukkan Kategori Produk" value="<?= $pro_name ?>">
								</div>
							</div>
							...
							<div class="col-sm-4">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="pro_title" placeholder="Masukkan Nama Produk" value="<?= $pro_title ?>">
								</div>
							</div>
							...
							<div class="col-sm-4">
								<div class="input-group col-sm-12">
									<textarea rows="4" class="form-control" name="pro_description" placeholder="Masukkan deskripsi produk , Contoh : Yamaha Classic Guitar GL-1 Top : Spruce, Back & Side/Rib : Meranti, Neck : Nato, Finger Board & Bridge : Sonokeling"><?= $pro_description ?></textarea>
								</div>
							</div>
							...
							<div class="col-sm-3">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="pro_price" placeholder="Masukkan Harga Produk" value="<?= $pro_price ?>">
