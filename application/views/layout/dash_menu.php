				...
				<div class="panel panel-default " >
					<div class="panel-body">
						...
						<div class="span7 offset5">
							...
							<?=  anchor('admin/products','Semua Produk',['class'=>'btn btn-default']) ?>
							<?=  anchor('admin/products/create','Tambah Produk Baru',['class'=>'btn btn-default']) ?>
							<?=  anchor('admin/products/members','Anggota',['class'=>'btn btn-default']) ?>
